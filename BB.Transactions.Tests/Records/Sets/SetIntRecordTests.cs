...
namespace BB.Transactions.Tests.Records.Sets
{
    public class SetIntRecordTests
    {
        ...
        public void CanWriteSetIntRecordToLog()
        {
            ...
            var currentRecord = logRecord.Current as SetIntRecord;
        ...
        public void CanWriteSetIntRecordMultipleTimesToLog()
        {
            ...
            var logRecord = new LogRecordEnumerator(_logManager, _bufferManager);
            var currentRecord2 = logRecord.Current as SetIntRecord;
            logRecord.MoveNext();
            var currentRecord1 = logRecord.Current as SetIntRecord;
